...
NY_CRIME_URL = f'https://drive.google.com/file/d/{crime_file_id}/view?usp=sharing'
# NY_CRIME_URL = f'https://drive.google.com/uc?id=' + NY_CRIME_URL.split('/')[-2]
# NY_ARREST_URL = f'/content/drive/My Drive/Datasets/ny_crime_data/ny_arrest_data/NYPD_Arrests_Data_Historic_.csv'
NY_ARREST_URL = f'https://drive.google.com/file/d/{arrest_file_id}/view?usp=sharing'
# NY_ARREST_URL = f'https://drive.google.com/uc?id=' + NY_ARREST_URL.split('/')[-2]
# ny_crime_df = read_spark_data(NY_CRIME_URL, crime_file_id)
# ny_arrest_df = read_spark_data(NY_ARREST_URL, arrest_file_id)
# print(ny_crime_df.count)
